...
function Dashboard() {
  ...
  // Get userId from AuthContext user data - no fallback to prevent wrong user ID

  const userId = user?.id



  // Debug user data and userId
  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      console.log('❌ User is null/undefined - AuthContext issue!')
